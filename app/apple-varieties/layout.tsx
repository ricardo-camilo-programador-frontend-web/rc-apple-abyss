...
export const metadata: Metadata = {
  ...
  description:
    'Discover the origin and meaning behind popular apple varieties like Fuji, Honeycrisp, Granny Smith and more.',
  openGraph: {
...
export default function AppleVarietiesLayout({ children }: { children: React.ReactNode }) {
  return <>{children}</>;
}
