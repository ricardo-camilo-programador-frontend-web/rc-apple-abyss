...
export default function GameFooter({ t }: GameFooterProps) {
  return (
    <footer className="flex-shrink-0 bg-white/80 dark:bg-stone-800/80 backdrop-blur-sm border-t border-stone-200/50 dark:border-stone-700/50 p-3 md:p-4 flex flex-col md:flex-row justify-between items-center text-[10px] md:text-xs text-stone-400 dark:text-stone-400 z-10 gap-3 md:gap-2">
