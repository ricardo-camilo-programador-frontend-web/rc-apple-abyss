...
export const WORM_UPGRADES: Array<WormUpgrade> = [
  {
    id: 'small_worm',
    nameKey: 'upgrade_small_worm',
    baseCost: 15,
    baseDPS: 1,
    costGrowth: 1.15,
    dpsGrowth: 1.18,
  ...
  {
    id: 'dimensional_worm',
    nameKey: 'upgrade_dimensional_worm',
...
export const LOCALIZATION: LocalizationData = {
  game_title: {
    en: 'Apple of the Infinite Abyss',
    zh: '无尽深渊之苹果',
    hi: 'अनंत रसातल का सेब',
    es: 'Manzana del Abismo Infinito',
    fr: "Pomme de l'Abîme Infini",
    ar: 'تفاحة الهاوية اللانهائية',
    bn: 'অনন্ত অতল গহ্বরের আপেল',
    pt: 'Maçã do Abismo Infinito',
    ru: 'Яблоко бесконечной бездны',
    ur: 'لامتناہی پاتال کا سیب',
    id: 'Apel dari Jurang Tak Terbatas',
    de: 'Apfel des unendlichen Abgrunds',
    ja: '無限の深淵のリンゴ',
    sw: 'Tofaa la Shimo Lisilo na Mwisho',
    mr: 'अनंत अथांग डोहातील सफरचंद',
    te: 'అనంతమైన అగాధపు ఆపిల్',
    tr: 'Sonsuz Uçurumun Elması',
    ta: 'முடிவிலா படுகுழியின் ஆப்பிள்',
    vi: 'Quả táo của vực thẳm vô tận',
    ko: '무한한 심연의 사과',
  },
  gold: {
    en: 'Gold',
  ...
  upgrade_hungry_worm: {
    ...
    de: 'Hungriger Wurm',
    ja: 'お腹を空かせた虫',
    sw: 'Minyoo Mwenye Njaa',
    mr: 'भुकेलेला कीडा',
    te: 'ఆకలితో ఉన్న పురుగు',
    tr: 'Aç Solucan',
    ta: 'பசியுள்ள புழு',
    vi: 'Sâu đói',
    ko: '배고픈 벌레',
  ...
  upgrade_galactic_worm: {
    ...
    ar: 'دودة مجرية',
    bn: 'গ্যালাকটিক পোকা',
    pt: 'Minhoca Galáctica',
    ru: 'Галактический червь',
    ur: 'کہکشاں کیڑا',
    id: 'Cacing Galaksi',
    de: 'Galaktischer Wurm',
    ja: 'ギャラクティックワーム',
    sw: 'Minyoo wa Kigalaksi',
    mr: 'गॅलॅक्टिक कीडा',
    te: 'గెలాక్సీ పురుగు',
    tr: 'Galaktik Solucan',
    ta: 'கேலக்ஸி புழு',
  ...
  upgrade_dimensional_worm: {
    ...
    zh: '维度虫子',
    hi: 'आयामी कीड़ा',
    es: 'Gusano Dimensional',
    fr: 'Ver Dimensionnel',
    ar: 'دودة الأبعاد',
    bn: 'মাত্রিক পোকা',
    pt: 'Minhoca Dimensional',
    ru: 'Пространственный червь',
    ur: 'جہتی کیڑا',
    id: 'Cacing Dimensi',
    de: 'Dimensionswurm',
    ja: 'ディメンショナルワーム',
  ...
  upgrade_infinite_worm: {
    ...
    bn: 'অসীম পোকা',
    pt: 'Minhoca Infinita',
    ru: 'Бесконечный червь',
    ur: 'لامتناہی کیڑا',
    id: 'Cacing Tak Terbatas',
    de: 'Unendlicher Wurm',
    ja: 'インフィニットワーム',
    sw: 'Minyoo Asiye na Mwisho',
    mr: 'अनंत कीडा',
    te: 'అనంతమైన పురుగు',
    tr: 'Sonsuz Solucan',
    ta: 'முடிவிலா புழு',
  ...
  pending_souls: {
    en: 'Pending Lucky Worms',
    zh: '待领取的幸运虫',
    hi: 'लंबित लकी वर्म्स',
    es: 'Gusanos de la Suerte Pendientes',
    fr: 'Vers Chanceux en attente',
    ar: 'الديدان المحظوظة المعلقة',
    bn: 'মুলতুবি লাকি ওয়ার্ম',
    pt: 'Vermes da Sorte Pendentes',
    ru: 'Ожидающие счастливые черви',
    ur: 'باقی لکی کیڑے',
    id: 'Cacing Keberuntungan Tertunda',
    de: 'Ausstehende Glückswürmer',
    ja: '保留中のラッキーワーム',
    sw: 'Minyoo ya Bahati Inayosubiri',
    mr: 'प्रलंबित लकी वर्म्स',
    te: 'పెండింగ్ లక్కీ వార్మ్స్',
    tr: 'Bekleyen Şanslı Solucanlar',
    ta: 'நிலுவையில் உள்ள லக்கி வார்ம்ஸ்',
    vi: 'Sâu may mắn chờ xử lý',
    ko: '대기 중인 럭키 웜',
  },
  ascension_desc: {
  ...
  ascend_requirement: {
    en: 'Reach stage 50 to ascend',
    zh: '达到 50 关即可飞升',
    hi: 'आरोहण के लिए चरण 50 तक पहुँचें',
    es: 'Llega a la etapa 50 para ascender',
    fr: "Atteignez l'étape 50 pour l'ascension",
    ar: 'صل إلى المرحلة 50 للصعود',
    bn: 'আরোহণের জন্য ৫০ পর্যায়ে পৌঁছান',
    pt: 'Alcance o estágio 50 para ascender',
    ru: 'Достигните 50 этапа, чтобы вознестись',
    ur: 'عروج کے لیے مرحلہ 50 تک پہنچیں',
    id: 'Capai tahap 50 untuk naik',
    de: 'Erreiche Stufe 50, um aufzusteigen',
    ja: '昇天するにはステージ50に到達してください',
    sw: 'Fika hatua ya 50 ili upande',
    mr: 'आरोहण करण्यासाठी टप्पा ५० गाठा',
    te: 'ఆరోహణకు 50వ దశకు చేరుకోండి',
    tr: 'Yükselmek için 50. aşamaya ulaşın',
    ta: 'ஏறுவதற்கு நிலை 50 ஐ அடையுங்கள்',
    vi: 'Đạt đến giai đoạn 50 để thăng hoa',
    ko: '승천하려면 50단계에 도달하세요',
  },
  stats: {
    en: 'Stats',
    zh: '统计',
  ...
  total_eaten: {
    ...
    fr: 'Total Mangé',
    ar: 'إجمالي المأكول',
    bn: 'মোট খাওয়া হয়েছে',
    pt: 'Total Comido',
    ru: 'Всего съедено',
    ur: 'کل کھایا گیا',
    id: 'Total Dimakan',
    de: 'Insgesamt gegessen',
    ja: '合計捕食数',
    sw: 'Jumla ya Vilivyoliwa',
    mr: 'एकूण खाल्ले',
    te: 'మొత్తం తిన్నది',
    tr: 'Toplam Yenilen',
    ta: 'மொத்தம் சாப்பிட்டது',
    vi: 'Tổng cộng đã ăn',
    ko: '총 섭취량',
  },
  settings: {
  ...
  apple_guide_footer_link: {
    en: 'Apple Varieties Guide',
    zh: '苹果品种指南',
    hi: 'सेब की किस्मों का गाइड',
    es: 'Guía de Variedades de Manzana',
    fr: 'Guide des Variétés de Pommes',
    ar: 'دليل أصناف التفاح',
    bn: 'আপেল জাতের নির্দেশিকা',
    pt: 'Guia de Variedades de Maçã',
    ru: 'Гид по сортам яблок',
    ur: 'سیب کی اقسام کا گائیڈ',
    id: 'Panduan Varietas Apel',
    de: 'Leitfaden für Apfelsorten',
    ja: 'リンゴ品種ガイド',
    sw: 'Mwongozo wa Aina za Tofaa',
    mr: 'सफरचंद जातींचे मार्गदर्शक',
    te: 'ఆపిల్ రకాల గైడ్',
    tr: 'Elma Çeşitleri Rehberi',
    ta: 'ஆப்பிள் வகைகள் வழிகாட்டி',
    vi: 'Hướng dẫn các loại táo',
    ko: '사과 품종 가이드',
  },
  apple_guide_title: {
    en: 'The Origins of Apple Names',
    zh: '苹果名称的起源',
    hi: 'सेब के नामों की उत्पत्ति',
    es: 'Los Orígenes de los Nombres de las Manzanas',
    fr: "L'Origine des Noms de Pommes",
    ar: 'أصول أسماء التفاح',
    bn: 'আপেলের নামের উৎপত্তি',
    pt: 'As Origens dos Nomes das Maçãs',
    ru: 'Происхождение названий яблок',
    ur: 'سیب کے ناموں کا آغاز',
    id: 'Asal Usul Nama Apel',
    de: 'Die Ursprünge der Apfelnamen',
    ja: 'リンゴの名前の由来',
    sw: 'Asili ya Majina ya Tofaa',
    mr: 'सफरचंदांच्या नावांची उत्पत्ती',
    te: 'ఆపిల్ పేర్ల మూలాలు',
    tr: 'Elma İsimlerinin Kökenleri',
    ta: 'ஆப்பிள் பெயர்களின் தோற்றம்',
    vi: 'Nguồn gốc tên các loại táo',
    ko: '사과 이름의 기원',
  },
  apple_guide_intro: {
  ...
  apple_guide_source_title: {
    en: 'Infographic Source',
    zh: '信息图来源',
    hi: 'इन्फोग्राफिक स्रोत',
    es: 'Fuente de la Infografía',
    fr: "Source de l'Infographie",
    ar: 'مصدر الإنفوجرافيك',
    bn: 'ইনফোগ্রাফিক উৎস',
    pt: 'Fonte da Infografia',
    ru: 'Источник инфографики',
    ur: 'انفوگرافک ذریعہ',
    id: 'Sumber Infografis',
    de: 'Quelle der Infografik',
    ja: 'インフォグラフィックのソース',
    sw: 'Chanzo cha Infografia',
    mr: 'इन्फोग्राफिक स्रोत',
    te: 'ఇన్ఫోగ్రాఫిక్ మూలం',
    tr: 'İnfografik Kaynağı',
    ta: 'தகவல் வரைபட ஆதாரம்',
    vi: 'Nguồn đồ họa thông tin',
    ko: '인포그래픽 출처',
  },
  apple_guide_source_credit: {
    en: 'Original post on Reddit CoolGuides community',
    zh: 'Reddit CoolGuides 社区的原始帖子',
    hi: 'Reddit CoolGuides समुदाय पर मूल पोस्ट',
    es: 'Publicación original en la comunidad Reddit CoolGuides',
    fr: 'Message original sur la communauté Reddit CoolGuides',
    ar: 'المنشور الأصلي على مجتمع Reddit CoolGuides',
    bn: 'Reddit CoolGuides কমিউনিটিতে মূল পোস্ট',
    pt: 'Post original na comunidade Reddit CoolGuides',
    ru: 'Оригинальный пост в сообществе Reddit CoolGuides',
    ur: 'Reddit CoolGuides کمیونٹی پر اصل پوسٹ',
    id: 'Postingan asli di komunitas Reddit CoolGuides',
    de: 'Originalbeitrag in der Reddit CoolGuides-Community',
    ja: 'Reddit CoolGuidesコミュニティの元の投稿',
    sw: 'Chapisho asili kwenye jumuiya ya Reddit CoolGuides',
    mr: 'Reddit CoolGuides समुदायावरील मूळ पोस्ट',
    te: 'Reddit CoolGuides కమ్యూనిటీలో అసలు పోస్ట్',
    tr: 'Reddit CoolGuides topluluğundaki orijinal gönderi',
    ta: 'Reddit CoolGuides சமூகத்தில் அசல் இடுகை',
    vi: 'Bài đăng gốc trên cộng đồng Reddit CoolGuides',
    ko: 'Reddit CoolGuides 커뮤니티의 원본 게시물',
  },
  apple_guide_varieties_title: {
    en: 'Apple Varieties & Their Origins',
    zh: '苹果品种及其起源',
    hi: 'सेब की किस्में और उनकी उत्पत्ति',
    es: 'Variedades de Manzana y sus Orígenes',
    fr: 'Variétés de Pommes et leurs Origines',
    ar: 'أصناف التفاح وأصولها',
    bn: 'আপেল জাত এবং তাদের উৎপত্তি',
    pt: 'Variedades de Maçã e suas Origens',
    ru: 'Сорта яблок и их происхождение',
    ur: 'سیب کی اقسام اور ان کا آغاز',
    id: 'Varietas Apel & Asal Usulnya',
    de: 'Apfelsorten und ihre Ursprünge',
    ja: 'リンゴの品種とその由来',
    sw: 'Aina za Tofaa na Asili Zake',
    mr: 'सफरचंद जाती आणि त्यांची उत्पत्ती',
    te: 'ఆపిల్ రకాలు & వాటి మూలాలు',
    tr: 'Elma Çeşitleri ve Kökenleri',
    ta: 'ஆப்பிள் வகைகள் மற்றும் அவற்றின் தோற்றம்',
    vi: 'Các loại táo & Nguồn gốc của chúng',
    ko: '사과 품종 및 기원',
  },
  ...
  apple_variety_ambrosia_desc: {
    en: 'Discovered as a chance seedling in British Columbia, named for the "food of the gods" in Greek mythology.',
  },
  apple_variety_baldwin: { en: 'Baldwin' },
  apple_variety_baldwin_desc: {
    en: 'Named after Loammi Baldwin, who popularized it in Massachusetts in the late 18th century.',
  },
  apple_variety_braeburn: { en: 'Braeburn' },
  apple_variety_braeburn_desc: {
    en: 'Discovered as a chance seedling in New Zealand in 1952, named after Braeburn Orchard.',
  },
  apple_variety_cameo: { en: 'Cameo' },
  apple_variety_cameo_desc: {
    en: 'Discovered as a chance seedling in Washington state in 1987, possibly a cross between Red and Golden Delicious.',
  },
  apple_variety_cortland: { en: 'Cortland' },
  apple_variety_cortland_desc: {
    en: 'Developed at the New York State Agricultural Experiment Station in 1898, named after Cortland County.',
  },
  apple_variety_coxs_orange_pippin: { en: "Cox's Orange Pippin" },
  apple_variety_coxs_orange_pippin_desc: {
    en: 'Raised by Richard Cox in Buckinghamshire, England, in 1825.',
  },
  apple_variety_crabapple: { en: 'Crabapple' },
  apple_variety_crabapple_desc: {
    en: 'A generic name for wild apples, from the Middle English "crabbe" meaning sour or sharp.',
  },
  apple_variety_empire: { en: 'Empire' },
  apple_variety_empire_desc: {
    en: 'A cross between McIntosh and Red Delicious, developed in New York (the Empire State) in 1945.',
  },
  apple_variety_envy: { en: 'Envy' },
  apple_variety_envy_desc: {
    en: 'A trademarked brand for the Scilate variety, developed in New Zealand in 2008.',
  },
  apple_variety_fuji: { en: 'Fuji' },
  apple_variety_fuji_desc: {
    en: 'Developed in Japan in the 1930s, named after the town of Fujisaki and Mount Fuji.',
  },
  apple_variety_golden_delicious: { en: 'Golden Delicious' },
  apple_variety_golden_delicious_desc: {
    en: 'Discovered as a chance seedling in West Virginia in 1890, unrelated to Red Delicious.',
  },
  apple_variety_granny_smith: { en: 'Granny Smith' },
  apple_variety_granny_smith_desc: {
    en: 'Discovered by Maria Ann Smith in Australia in 1868, who found it growing in a compost pile.',
  },
  apple_variety_honeycrisp: { en: 'Honeycrisp' },
  apple_variety_honeycrisp_desc: {
    en: 'Developed at the University of Minnesota in the 1960s, prized for its crisp texture.',
  },
  apple_variety_idared: { en: 'Idared' },
  apple_variety_idared_desc: {
    en: 'Developed in Idaho in 1942, a cross between Jonathan and Wagener.',
  },
  apple_variety_jazz: { en: 'Jazz' },
  apple_variety_jazz_desc: {
    en: 'A cross between Royal Gala and Braeburn, developed in New Zealand in 1999.',
  },
  apple_variety_jonagold: { en: 'Jonagold' },
  apple_variety_jonagold_desc: {
    en: 'A cross between Jonathan and Golden Delicious, developed in New York in 1953.',
  },
  apple_variety_jonathan: { en: 'Jonathan' },
  apple_variety_jonathan_desc: {
    en: 'Named after Jonathan Hasbrouck, who discovered it in New York in the early 19th century.',
  },
  apple_variety_macoun: { en: 'Macoun' },
  apple_variety_macoun_desc: {
    en: 'Named after W.T. Macoun, a Canadian pomologist, developed in New York in 1909.',
  },
  ...
  apple_variety_northern_spy_desc: {
    en: 'Discovered in Connecticut in 1800, possibly named after a character in a popular book of the time.',
  },
  apple_variety_opal: { en: 'Opal' },
  apple_variety_opal_desc: {
    en: 'A cross between Golden Delicious and Topaz, developed in the Czech Republic in 1999.',
  },
  apple_variety_pacific_rose: { en: 'Pacific Rose' },
  apple_variety_pacific_rose_desc: {
    en: 'A cross between Gala and Splendour, developed in New Zealand in 1990.',
  },
  apple_variety_pink_lady: { en: 'Pink Lady' },
  apple_variety_pink_lady_desc: {
    en: 'A brand name for the Cripps Pink variety, developed by John Cripps in Australia in 1973.',
  },
  apple_variety_red_delicious: { en: 'Red Delicious' },
  apple_variety_red_delicious_desc: {
    en: 'Discovered in Iowa in 1872, originally named "Hawkeye".',
  },
  apple_variety_rome: { en: 'Rome' },
  apple_variety_rome_desc: {
    en: 'Named after Rome Township, Ohio, where it was discovered in 1817.',
  },
  apple_variety_royal_gala: { en: 'Royal Gala' },
  apple_variety_royal_gala_desc: {
    en: 'A mutation of the Gala variety, named in honor of Queen Elizabeth II during a visit to New Zealand.',
  },
  apple_variety_snapdragon: { en: 'SnapDragon' },
  apple_variety_snapdragon_desc: {
    en: 'Developed at Cornell University in 2011, a cross between Honeycrisp and an unnamed variety.',
  },
  apple_variety_sonya: { en: 'Sonya' },
  apple_variety_sonya_desc: {
    en: 'A cross between Gala and Red Delicious, developed in New Zealand in 2002.',
  },
  apple_variety_sugarbee: { en: 'SugarBee' },
  apple_variety_sugarbee_desc: {
    en: 'A cross between Honeycrisp and an unknown variety, discovered in Minnesota.',
  },
  apple_variety_sweetango: { en: 'SweeTango' },
  apple_variety_sweetango_desc: {
    en: 'A cross between Honeycrisp and Zestar, developed in Minnesota in 2009.',
  },
  apple_variety_winter_banana: { en: 'Winter Banana' },
  apple_variety_winter_banana_desc: {
    en: 'Discovered in Indiana in 1876, named for its distinct banana-like aroma.',
  },
  ...
  ascend_now: {
    ...
    hi: 'अभी आरोहण करें！',
    es: '¡Ascender Ahora!',
    fr: 'Ascender Maintenant!',
    ar: 'اصعد الآن!',
    bn: 'এখনই আরোহণ করুন!',
    pt: 'Ascender Agora!',
    ru: 'Вознестись!',
    ur: 'ابھی عروج حاصل کریں!',
    id: 'Naik Sekarang!',
    de: 'Jetzt aufsteigen!',
    ja: '今すぐ昇天！',
    sw: 'Panda Sasa!',
  ...
  reset_confirm: {
    en: 'Are you sure you want to completely reset your game? This cannot be undone!',
  },
  ...
  onboarding_step1_description: {
    en: 'Tap the apple to deal damage and earn gold. Each click brings you closer to the next stage.',
  },
  onboarding_step2_title: { en: 'Buy Worms' },
  onboarding_step2_description: {
    en: 'Spend gold on worm upgrades. Worms automatically eat apples even while you are away.',
  },
  onboarding_step3_title: { en: 'Ascend for Power' },
  onboarding_step3_description: {
    en: 'When you reach a high enough stage, ascend to gain Lucky Worms. They permanently boost your gold income.',
  },
