...
export const LOCALIZATION: LocalizationData = {
  ...
  pending_souls: {
    en: 'Pending Lucky Worms', zh: '待领取的幸运虫', hi: 'लंबित लकी वर्म्स', es: 'Gusanos de la Suerte Pendientes', fr: 'Vers Chanceux en attente', ar: 'الديدان المحظوظة المعلقة', bn: 'মুলতুবি লাকি ওয়ার্ম', pt: 'Vermes da Sorte Pendentes', ru: 'Ожидающие счастливые черви', ur: 'باقی لکی کیڑے',
    id: 'Cacing Keberuntungan Tertunda', de: 'Ausstehende Glückswürmer', ja: '保留中のラッキーワーム', sw: 'Minyoo ya Bahati Inayosubiri', mr: 'प्रलंबित लकी वर्म्स', te: 'పెండింగ్ లక్కీ వార్మ్స్', tr: 'Bekleyen Şanslı Solucanlar', ta: 'நிலுவையில் உள்ள லக்கி வார்ம்ஸ்', vi: 'Sâu may mắn chờ xử lý', ko: '대기 중인 럭키 웜'
  },
  ascension_desc: {
    en: 'Ascending resets your progress but grants Lucky Worms. Each Lucky Worm increases your gold earnings by 5%.',
    zh: '飞升会重置你的进度，但会授予幸运虫。每条幸运虫都会增加 5% 的金币收入。',
    hi: 'आरोहण आपकी प्रगति को रीसेट करता है लेकिन लकी वर्म्स प्रदान करता है। प्रत्येक लकी वर्म आपकी सोने की कमाई को 5% तक बढ़ाता है।',
    es: 'Ascender reinicia tu progreso pero otorga Gusanos de la Suerte. Cada Gusano de la Suerte aumenta tus ganancias de oro en un 5%.',
    fr: 'L\'ascension réinitialise votre progression mais accorde des Vers Chanceux. Chaque Ver Chanceux augmente vos gains d\'or de 5%.',
    ar: 'الصعود يعيد ضبط تقدمك ولكنه يمنح الديدان المحظوظة. كل دودة محظوظة تزيد من مكاسبك من الذهب بنسبة 5٪.',
    bn: 'আরোহণ আপনার অগ্রগতি রিসেট করে কিন্তু লাকি ওয়ার্ম প্রদান করে। প্রতিটি লাকি ওয়ার্ম আপনার সোনা উপার্জন 5% বৃদ্ধি করে।',
    pt: 'Ascender redefine seu progresso, mas concede Vermes da Sorte. Cada Verme da Sorte aumenta seus ganhos de ouro em 5%.',
    ru: 'Вознесение сбрасывает ваш прогресс, но дает Счастливых Червей. Каждый Счастливый Червь увеличивает ваш заработок золота на 5%.',
    ur: 'عروج آپ کی پیش رفت کو دوبارہ ترتیب دیتا ہے لیکن لکی کیڑے دیتا ہے۔ ہر لکی کیڑا آپ کی سونے کی کمائی میں 5% اضافہ کرتا ہے۔',
    id: 'Kenaikan mengatur ulang kemajuan Anda tetapi memberikan Cacing Keberuntungan. Setiap Cacing Keberuntungan meningkatkan penghasilan emas Anda sebesar 5%.',
    de: 'Der Aufstieg setzt deinen Fortschritt zurück, gewährt aber Glückswürmer. Jeder Glückswurm erhöht deine Goldeinnahmen um 5%.',
  ...
  /* ─── Journey: Onboarding ─── */
  onboarding_title: { en: 'Welcome to the Abyss' },
  onboarding_step1_title: { en: 'Click to Eat' },
  onboarding_step1_description: { en: 'Tap the apple to deal damage and earn gold. Each click brings you closer to the next stage.' },
  onboarding_step2_title: { en: 'Buy Worms' },
  onboarding_step2_description: { en: 'Spend gold on worm upgrades. Worms automatically eat apples even while you are away.' },
  onboarding_step3_title: { en: 'Ascend for Power' },
  onboarding_step3_description: { en: 'When you reach a high enough stage, ascend to gain Lucky Worms. They permanently boost your gold income.' },
  onboarding_next: { en: 'Next' },
  onboarding_skip: { en: 'Skip' },
  onboarding_start: { en: 'Start Playing' },

  /* ─── Journey: Goals ─── */
  journey_title: { en: 'Journey' },
  journey_short: { en: 'Journey' },
  first_apple_name: { en: 'First Apple' },
  ten_apples_name: { en: 'Ten Apples' },
  hundred_apples_name: { en: '100 Apples' },
  five_hundred_apples_name: { en: '500 Apples' },
  thousand_apples_name: { en: '1,000 Apples' },
  first_upgrade_name: { en: 'First Upgrade' },
  five_upgrades_name: { en: '5 Upgrades' },
  ten_upgrades_name: { en: '10 Upgrades' },
  twenty_upgrades_name: { en: '20 Upgrades' },
  stage_ten_name: { en: 'Reach Stage 10' },
  stage_twenty_five_name: { en: 'Reach Stage 25' },
  stage_fifty_name: { en: 'Reach Stage 50' },
  stage_hundred_name: { en: 'Reach Stage 100' },
  first_ascension_name: { en: 'First Ascension' },
  five_ascensions_name: { en: '5 Ascensions' },
  ten_ascensions_name: { en: '10 Ascensions' },
  ten_lucky_worms_name: { en: '10 Lucky Worms' },
  fifty_lucky_worms_name: { en: '50 Lucky Worms' },
  golden_harvest_activation_name: { en: 'Use Golden Harvest' },
  first_apple_description: { en: 'Eat your very first apple.' },
  ten_apples_description: { en: 'Eat 10 apples in total.' },
  hundred_apples_description: { en: 'Eat 100 apples in total.' },
  five_hundred_apples_description: { en: 'Eat 500 apples in total.' },
  thousand_apples_description: { en: 'Eat 1,000 apples in total.' },
  first_upgrade_description: { en: 'Purchase your first worm upgrade.' },
  five_upgrades_description: { en: 'Purchase 5 worm upgrades in total.' },
  ten_upgrades_description: { en: 'Purchase 10 worm upgrades in total.' },
  twenty_upgrades_description: { en: 'Purchase 20 worm upgrades in total.' },
  stage_ten_description: { en: 'Reach stage 10.' },
  stage_twenty_five_description: { en: 'Reach stage 25.' },
  stage_fifty_description: { en: 'Reach stage 50.' },
  stage_hundred_description: { en: 'Reach stage 100.' },
  first_ascension_description: { en: 'Perform your first ascension.' },
  five_ascensions_description: { en: 'Perform 5 ascensions in total.' },
  ten_ascensions_description: { en: 'Perform 10 ascensions in total.' },
  ten_lucky_worms_description: { en: 'Collect 10 Lucky Worms.' },
  fifty_lucky_worms_description: { en: 'Collect 50 Lucky Worms.' },
  golden_harvest_activation_description: { en: 'Activate the Golden Harvest skill.' },
  goals_completed: { en: 'Completed ({count})' },
  goals_pending: { en: 'In Progress ({count})' },

  /* ─── Journey: Daily Reward ─── */
  daily_reward_title: { en: 'Daily Reward' },
  daily_reward_claim: { en: 'Claim Daily Reward' },
  daily_reward_claimed_day: { en: 'Day {day} reward claimed!' },
  daily_reward_next: { en: 'Next reward in {time}' },
};
